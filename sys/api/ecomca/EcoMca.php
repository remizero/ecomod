...
use sys\api\ecomca\core\ScanDirException;
use sys\core\abstracts\ApiAbs;
 ...
 * @uses .php
 * @see .php
 * @todo Corregir el problema del envío del mensaje de alerta cuando la
 *       opción "send" del archivo config.xml de la api ecomca estar configurada
 *       a 1.
 * @todo Corregir o agregar las posibles opciones de código potencialmente
 *       peligroso a escanear en el método isClean ().
 */
class EcoMca extends ApiAbs {
   ...
   *
   * @param array|string $dir Nombre o lista de nombres de los archivos o directorios a analizar
   ...
   * Permite obtener el o los archivos para ser analizados.
   *
   * @param string $file Nombre del archivo o directorio.
   *
   * @return void
   */
   ...
   *
   * @see \sys\core\abstracts\ApiAbs::isActive ()
   */
   ...
   *
   * @param array|string $files Archivo o lista de archivos para escanear. Puede contener archivos,
   ...
   * Función recursiva.
   *
   * @param string $dir Nombre del directorio a leer.
   *
