...
/**
 * <strong>WriteOnlyException</strong>
 ...
 *
 * @name WriteOnlyException
 * @namespace sys\libs\exceptions
 * @package ECOMOD.
 * @subpackage EXCEPTIONS.
 * @filesource WriteOnlyException.php
 * @version 1.0
 * @since 1.0
 ...
 *       </ul>
 */
class WriteOnlyException extends Exception {
  ...
  public function __construct ( string $propertyName ) {
    ...
    parent::__construct ( "The {$propertyName} property is write-only.", 0, null );
  }
