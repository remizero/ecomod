 ...
 * tipo JSON para la configuración del sistema ECOMOD.</p>
 *
 * @name Json
...
class Json extends ConfigAbs {
  ...
  /**
   * Método que permite analizar un archivo de configuración JSON.
   *
  ...
  /**
   * Método que permite leer un archivo de configuración JSON.
   *
  ...
  /**
   * Método que permite escribir un archivo de configuración JSON.
   *
